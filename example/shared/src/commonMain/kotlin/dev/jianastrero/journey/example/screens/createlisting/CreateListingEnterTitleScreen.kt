...
import dev.jianastrero.journey.example.journeys.CreateListingEnterTitleController
...
@Composable
internal fun CreateListingEnterTitleScreen(controller: CreateListingEnterTitleController, onCancel: () -> Unit) {
    var title by remember { mutableStateOf("") }
    var category by remember { mutableStateOf(listingCategories[0]) }
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("What are you selling?", style = MaterialTheme.typography.headlineSmall)
            OutlinedTextField(
                value = title,
