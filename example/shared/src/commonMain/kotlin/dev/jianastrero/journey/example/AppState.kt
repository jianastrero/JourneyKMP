...
private val sampleListings = listOf(
    Listing("1", "Vintage Leather Jacket", "Classic biker jacket in genuine leather, lightly worn with beautiful patina. Size M.", 89.99, "Clothing", "seller1"),
    Listing("2", "Sony WH-1000XM5 Headphones", "Industry-leading noise cancellation. Barely used, includes original box and all accessories.", 149.00, "Electronics", "seller2"),
    Listing("3", "The Art of Clean Code", "Paperback in excellent condition. A timeless guide to writing readable, maintainable software.", 29.99, "Books", "seller3"),
    Listing("4", "Artisan Ceramic Mug Set (6 pcs)", "Handmade mugs with food-safe glaze. Each one is unique — perfect for gifting.", 34.99, "Home", "seller1"),
    Listing("5", "Nike Air Max Running Shoes", "Size US 10. Worn twice, excellent condition. Original box included.", 79.99, "Clothing", "seller2"),
    Listing("6", "Smart LED Desk Lamp", "USB-C rechargeable, adjustable colour temperature 2700 K–6500 K, touch dimmer.", 49.99, "Electronics", "seller3"),
    Listing("7", "Succulent Collection (5 plants)", "Low-maintenance, pet-friendly varieties. Includes terracotta pots.", 24.99, "Home", "seller1"),
    Listing("8", "Kotlin in Action, 2nd Ed.", "Factory sealed, never opened. Comprehensive guide by JetBrains engineers.", 44.99, "Books", "seller2"),
)
